package com.acoptic.betterswordfight.client.renderer;

import com.acoptic.betterswordfight.model.ModelPlayerCustom;
...
public class RenderPlayerCustom extends RenderLivingBase<AbstractClientPlayer>
{
    ...
    {
        ModelPlayerCustom modelplayer = this.getMainModel();
